...
class Validate
{
    ...
    protected static $typeMsg = [
        'require'     => ':attribute 不能为空',//不能为空
        'number'      => ':attribute 必须是数字',//必须是数字
        'integer'     => ':attribute 必须是整数',//必须是整数
        'float'       => ':attribute 必须是浮点数',//必须是浮点数
        'boolean'     => ':attribute 必须是布尔值',//必须是布尔值
        'email'       => ':attribute 格式不符',//格式不符
        'array'       => ':attribute 必须是数组',//必须是数组
        'accepted'    => ':attribute 必须是yes、on或者1',//必须是yes、on或者1
        'date'        => ':attribute 格式不符合',//格式不符合
        'file'        => ':attribute 不是有效的上传文件',//不是有效的上传文件
        'image'       => ':attribute 不是有效的图像文件',//不是有效的图像文件
        'alpha'       => ':attribute 只能是字母',//只能是字母
        'alphaNum'    => ':attribute 只能是字母和数字',//只能是字母和数字
        'alphaDash'   => ':attribute 只能是字母、数字和下划线_及破折号-',//只能是字母、数字和下划线_及破折号-
        'activeUrl'   => ':attribute 不是有效的域名或者IP',//不是有效的域名或者IP
        'chs'         => ':attribute 只能是汉字',//只能是汉字
        'chsAlpha'    => ':attribute 只能是汉字、字母',//只能是汉字、字母
        'chsAlphaNum' => ':attribute 只能是汉字、字母和数字',//只能是汉字、字母和数字
        'chsDash'     => ':attribute 只能是汉字、字母、数字和下划线_及破折号',//只能是汉字、字母、数字和下划线_及破折号
        'url'         => ':attribute 不是有效的URL地址',//不是有效的URL地址
        'ip'          => ':attribute 不是有效的IP地址',//不是有效的IP地址
        'dateFormat'  => ':attribute 必须使用日期格式 :rule',//必须使用日期格式 :rule
        'in'          => ':attribute 必须在 :rule 范围内',//必须在 :rule 范围内
        'notIn'       => ':attribute 不能在 :rule 范围内',//不能在 :rule 范围内
        'between'     => ':attribute 只能在 :1 - :2 之间',//只能在 :1 - :2 之间
        'notBetween'  => ':attribute 不能在 :1 - :2 之间',//不能在 :1 - :2 之间
        'length'      => ':attribute 长度不符合要求 :rule',//长度不符合要求 :rule
        'max'         => ':attribute 长度不能超过 :rule',//长度不能超过 :rule
        'min'         => ':attribute 长度不能小于 :rule',//长度不能小于 :rule
        'after'       => ':attribute 日期不能小于 :rule',//日期不能小于 :rule
        'before'      => ':attribute 日期不能超过 :rule',//日期不能超过 :rule
        'expire'      => '不在有效期内 :rule',//不在有效期内 :rule
        'allowIp'     => '不允许的IP访问',//不允许的IP访问
        'denyIp'      => '禁止的IP访问',//禁止的IP访问
        'confirm'     => ':attribute 和确认字段:2不一致',//和确认字段:2不一致
        'different'   => ':attribute 和比较字段:2不能相同',//和比较字段:2不能相同
        'egt'         => ':attribute 必须大于等于 :rule',//必须大于等于 :rule
        'gt'          => ':attribute 必须大于 :rule',//必须大于 :rule
        'elt'         => ':attribute 必须小于等于 :rule',//必须小于等于 :rule
        'lt'          => ':attribute 必须小于 :rule',//必须小于 :rule
        'eq'          => ':attribute 必须等于 :rule',//必须等于 :rule
        'unique'      => ':attribute 已存在',//已存在
        'regex'       => ':attribute 不符合指定规则',//不符合指定规则
        'method'      => '无效的请求类型',//无效的请求类型
        'token'       => '令牌数据无效',//令牌数据无效
        'fileSize'    => '上传文件大小不符',//上传文件大小不符
        'fileExt'     => '上传文件后缀不符',//上传文件后缀不符
        'fileMime'    => '上传文件类型不符',//上传文件类型不符
    ];
