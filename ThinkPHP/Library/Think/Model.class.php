...
class Model
{
     ...
     */
    public function pageQuery($sql, $page = 0, $pageSize = 15)
    {
        ...
        //计算页码信息
        $pager['total'] = (int)$total[0]['counts'];
     ...
     */
    public function saveAll($datas, $table_name, $pk)
    {
        $sql = ''; //Sql
        $lists = []; //记录集$lists
        ...
        $sql = sprintf('UPDATE %s SET %s WHERE %s IN ( %s )', $table_name, rtrim($sql, ','), $pk, implode(',', $ids));
