...
require_once dirname(__FILE__) . "/TypeInterface.php";
//require_once dirname(dirname(__FILE__)) . "Barcode.php";
require_once dirname(dirname(__FILE__)) . "/Barcode.php";
require_once dirname(dirname(__FILE__)) . "/BarcodeBar.php";
...
class TypeCode128 implements TypeInterface
{
    ...
    public function getBarcodeData(string $code)
    {
