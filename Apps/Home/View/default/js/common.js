$.fn.TabPanel = function(options){
	...
	$(t).find('.wst-tab-nav li').click(function(){
		...
		if(opts.callback)opts.callback(index,$(this).val());
	});
...
$(function() {
	...
	$("#wst-panel-goods").click(function(){
		...
		$("#wst-panel-goods").css({"background-color":"#70aa39","border":"1px solid #70aa39","color":"#ffffff"});
	...
	$("#wst-panel-shop").click(function(){
		...
		$("#wst-panel-shop").css({"background-color":"#70aa39","border":"1px solid #70aa39","color":"#ffffff"});
...
function checkCart(){
	jQuery.post( Think.U('Home/Cart/getCartInfo') ,{"axm":1},function(data) {
		...
		if(flag){
			...
			// $(".gouwuc").css("background-color","orange");
			$(".scart").css({"background-image":"url(Apps/Home/View/default/images/cart_pop04_7d8dece41.png)"});
		}else{
			...
			// $(".gouwuc").css("background-color","#333");
		}
	});
}
function topay(){
