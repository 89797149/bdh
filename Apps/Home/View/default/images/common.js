...
$(function() {
	...
	$("#wst-panel-goods").click(function(){
		...
		$("#wst-panel-goods").css({"background-color":"#A3C502","border":"1px solid #A3C502","color":"#ffffff"});
	...
	$("#wst-panel-shop").click(function(){
		...
		$("#wst-panel-shop").css({"background-color":"#A3C502","border":"1px solid #A3C502","color":"#ffffff"});
