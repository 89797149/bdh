...
class DadaModel extends BaseModel {
     ...
     * 查询运费后发单接口
     */
	public function addAfterQuery($data,$source_id){
		$config = array();
		$config['app_key'] = $this->dadaAppKey;
		$config['app_secret'] = $this->dadaAppSecret;
		$config['url'] = $this->DadaOpenapiUrl."/api/order/addAfterQuery";
		$config['source_id'] = $source_id;
		$DadaOpenapi = new \Org\Util\DadaOpenapi($config);
     ...
     * 订单详情查询
     */
    public function getTplOrderInfo($data,$source_id){
        $config = array();
        $config['app_key'] = $this->dadaAppKey;
        $config['app_secret'] = $this->dadaAppSecret;
        $config['url'] = $this->DadaOpenapiUrl."/api/order/status/query";
        $config['source_id'] = $source_id;
        $DadaOpenapi = new \Org\Util\DadaOpenapi($config);
     ...
     * 取消订单
     */
    public function formalCancel($data,$source_id){
        $config = array();
        $config['app_key'] = $this->dadaAppKey;
        $config['app_secret'] = $this->dadaAppSecret;
        $config['url'] = $this->DadaOpenapiUrl."/api/order/formalCancel";
        $config['source_id'] = $source_id;
        $DadaOpenapi = new \Org\Util\DadaOpenapi($config);
